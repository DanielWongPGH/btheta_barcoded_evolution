...
load_dir = local_paths['rebarseq']
save_dir = pickled_dir
 
file_in = open(f'{load_dir}/all_barcode_reads.csv', 'r')  # for testing
header = next(file_in)
...
mouse_day0_map =  { 'E1': {1: ('E1','P2', 0), 2: ('E1','P2', 0), 3: ('E1','P2', 0), 4: ('E1','P2', 0), 5: ('E1','P2', 0), 
                          6: ('E1','P1', 0), 7: ('E1','P1', 0), 8: ('E1','P1', 0), 9: ('E1','P1', 0), 10: ('E1','P1', 0),
                          11: ('E1','P1', 0), 12: ('E1','P1', 0), 13: ('E1','P1', 0)},
                    'E2': {1: ('E2','S1', 0), 2: ('E2','S2', 0), 3: ('E2','S3', 0), 4: ('E2','S4', 0), 5: ('E2','S5', 0),
                           6: ('E2','S1', 0), 7: ('E2','S2', 0), 8: ('E2','S3', 0), 9: ('E2','S4', 0), 10: ('E2','S5', 0),
                           11: ('E2','S1delay', 0), 12: ('E2','S2delay', 0), 13: ('E2','S3delay', 0), 14: ('E2','S4delay', 0), 15: ('E2','S5delay', 0)}} 
day0_map = {}
for expt in ['E1', 'E2']:
